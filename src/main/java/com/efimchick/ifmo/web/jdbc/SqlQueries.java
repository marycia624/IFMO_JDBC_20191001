...
public class SqlQueries {
    ...
    //language=HSQLDB
    String select08 = "SELECT DEPARTMENT.NAME as depname, COUNT(EMPLOYEE.ID) as staff_size FROM DEPARTMENT, EMPLOYEE " +
            "WHERE DEPARTMENT.ID = EMPLOYEE.DEPARTMENT GROUP BY DEPARTMENT.NAME";
    ...
    //language=HSQLDB
    String select10 = "SELECT first.LASTNAME as employee, second.LASTNAME as manager FROM EMPLOYEE first " +
            "LEFT OUTER JOIN EMPLOYEE second ON first.MANAGER = second.ID";
